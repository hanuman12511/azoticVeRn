...
export default class EditMenuItemsScreen extends Component {
  constructor(props) {
    super(props);
  ...
  handleCustomizationNav = () => {
    ...
    const showMenuList = this.props.navigation.getParam('showMenuList', null);
    ...
    this.props.navigation.navigate('EditMenuItemsStep2', {
      item,
      refreshCall: showMenuList,
    });
  };
