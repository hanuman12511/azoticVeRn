...
export default class VendorNewOrderDetailScreen extends Component {
  constructor(props) {
    super(props);
    ...
    try {
      ...
      if (response) {
        ...
        if (success) {
          ...
          const fetchNewProducts = getParam('fetchNewProducts', null);
  ...
  handleDeclineOrder = () => {
    Alert.alert(
      'Order Status',
      'Sure, You want to decline the order?',
      [
        {text: 'NO', style: 'cancel'},
        {text: 'Decline', onPress: this.handleDecline},
      ],
      {
        cancelable: false,
      },
  ...
  handleDecline = async () => {
    ...
    try {
      ...
      const params = {orderId, status: 'cancelled'};
          ...
          <View style={[styles.buttonsContainer]}>
            <View
              ...
              <TouchableOpacity
                ...
                <Text style={[styles.acceptText, basicStyles.orangeColor]}>
                  Accept
                </Text>
              </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              <Text style={styles.acceptText}>Call Customer</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </SafeAreaView>
